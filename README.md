# Awesome Cryptography [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 473,285 | 🐛 83 | 📅 2026-06-02 with stars
...
* [Awesome crypto-papers](https://github.com/pFarb/awesome-crypto-papers) ⭐ 2,045 | 🐛 4 | 📅 2024-10-17 – A curated list of cryptography papers, articles, tutorials and howtos.
* [Awesome HE](https://github.com/jonaschn/awesome-he) ⭐ 1,252 | 🐛 9 | 📅 2025-03-25 – A curated list of homomorphic encryption libraries, software and resources.
...
* [certbot](https://github.com/certbot/certbot) ⭐ 33,071 | 🐛 199 | 🌐 Python | 📅 2026-06-04 - Previously the Let's Encrypt Client, is EFF's tool to obtain certs from Let's Encrypt, and (optionally) auto-enable HTTPS on your server. It can also act as a client for any other CA that uses the ACME protocol.
* [sops](https://github.com/mozilla/sops) ⭐ 22,012 | 🐛 425 | 🌐 Go | 📅 2026-06-04 - sops is an editor of encrypted files that supports YAML, JSON and BINARY formats and encrypts with AWS KMS, GCP KMS, Azure Key Vault and PGP.
* [cryptomator](https://github.com/cryptomator/cryptomator) ⭐ 15,212 | 🐛 294 | 🌐 Java | 📅 2026-06-05 - Multi-platform transparent client-side encryption of your files in the cloud.
* [blackbox](https://github.com/StackExchange/blackbox) ⚠️ Archived - safely store secrets in Git/Mercurial/Subversion.
* [Nipe](https://github.com/GouveaHeitor/nipe) ⭐ 2,344 | 🐛 11 | 🌐 Perl | 📅 2026-05-30 - Nipe is a script to make Tor Network your default gateway.
...
* [git-crypt](https://github.com/AGWA/git-crypt) ⭐ 9,720 | 🐛 125 | 🌐 C++ | 📅 2025-09-24 - Transparent file encryption in git.
...
* [OpenSSL](https://github.com/openssl/openssl) ⭐ 30,262 | 🐛 1,576 | 🌐 C | 📅 2026-06-03 - TLS/SSL and crypto library.
* [libsodium](https://github.com/jedisct1/libsodium) ⭐ 13,730 | 🐛 1 | 🌐 C | 📅 2026-05-31 - Modern and easy-to-use crypto library.
* [xxHash](https://github.com/Cyan4973/xxHash) ⭐ 11,060 | 🐛 34 | 🌐 C | 📅 2026-04-13 - Extremely fast hash algorithm.
* [tiny-AES128-C](https://github.com/kokke/tiny-AES128-C) ⭐ 4,963 | 🐛 34 | 🌐 C | 📅 2024-10-04 - Small portable AES128 in C.
* [wolfSSL](https://github.com/wolfSSL/wolfssl) ⭐ 2,847 | 🐛 125 | 🌐 C | 📅 2026-06-05 - Small, fast, portable implementation of TLS/SSL for embedded devices to the cloud.
* [crypto-algorithms](https://github.com/B-Con/crypto-algorithms) ⭐ 2,021 | 🐛 33 | 🌐 C | 📅 2020-12-28 - Basic implementations of standard cryptography algorithms, like AES and SHA-1.
* [themis](https://github.com/cossacklabs/themis) ⭐ 1,966 | 🐛 31 | 🌐 C | 📅 2026-04-24 - High level crypto library for storing data (AES), secure messaging (ECC + ECDSA / RSA + PSS + PKCS#7) and session-oriented, forward secrecy data exchange (ECDH key agreement, ECC & AES encryption). Ported on many languages and platforms, suitable for client-server infastructures.
* [libtomcrypt](https://github.com/libtom/libtomcrypt) ⭐ 1,773 | 🐛 61 | 🌐 C | 📅 2026-05-25 - Fairly comprehensive, modular and portable cryptographic toolkit.
* [RHash](https://github.com/rhash/RHash) ⭐ 715 | 🐛 42 | 🌐 C | 📅 2026-04-11 - Great utility for computing hash sums.
* [XKCP](https://github.com/XKCP/XKCP) ⭐ 656 | 🐛 13 | 🌐 C | 📅 2026-06-01 — is a repository that gathers different free and open-source implementations of the cryptographic schemes defined by the Keccak team.
* [libkcapi](https://github.com/smuellerDD/libkcapi) ⭐ 195 | 🐛 5 | 🌐 C | 📅 2026-05-12 - Linux Kernel Crypto API User Space Interface Library.
* [nettle](https://github.com/gnutls/nettle) ⭐ 73 | 🐛 0 | 🌐 C | 📅 2026-06-05 - is a cryptographic library that is designed to fit easily in more or less any context: In crypto toolkits for object-oriented languages (C++, Python, Pike, ...), in applications like LSH or GNUPG, or even in kernel space.
* [libVES.c](https://github.com/vesvault/libVES.c) ⭐ 40 | 🐛 0 | 🌐 C | 📅 2026-05-26 - End-to-end encrypted sharing via cloud repository, secure recovery through a viral network of friends in case of key loss.
...
* [cryptopp](https://github.com/weidai11/cryptopp) ⭐ 5,464 | 🐛 90 | 🌐 C++ | 📅 2026-05-20 - Crypto++ Library is a free C++ class library of cryptographic schemes.
* [s2n](https://github.com/awslabs/s2n) ⭐ 4,732 | 🐛 308 | 🌐 C | 📅 2026-06-06 - Implementation of the TLS/SSL protocols.
...
* [SynCrypto](https://github.com/synopse/mORMot/blob/master/SynCrypto.pas) ⭐ 822 | 🐛 9 | 🌐 Pascal | 📅 2026-06-05 - Fast cryptographic routines (hashing and cypher), implementing AES, XOR, RC4, ADLER32, MD5, SHA1, SHA256 algorithms, optimized for speed.
* [DelphiEncryptionCompendium](https://github.com/winkelsdorf/DelphiEncryptionCompendium/releases) ⭐ 282 | 🐛 23 | 🌐 HTML | 📅 2026-03-29 - Cryptographic library for Delphi.
...
* [cloak](https://github.com/danielberkompas/cloak) ⭐ 621 | 🐛 11 | 🌐 Elixir | 📅 2026-03-14 - Cloak makes it easy to use encryption with Ecto.
...
* [goThemis](https://github.com/cossacklabs/themis/wiki/Go-Howto) ⭐ 1,966 | 🐛 31 | 🌐 C | 📅 2026-04-24 - Go wrapper on Themis. High level crypto library for storing data (AES), secure messaging (ECC + ECDSA / RSA + PSS + PKCS#7) and session-oriented, forward secrecy data exchange (ECDH key agreement, ECC & AES encryption).
* [kyber](https://github.com/dedis/kyber) ⭐ 698 | 🐛 28 | 🌐 Go | 📅 2026-05-23 - Advanced crypto library for the Go language.
...
* [cryptol](https://github.com/GaloisInc/cryptol) ⭐ 1,209 | 🐛 265 | 🌐 Haskell | 📅 2026-06-05 - The Language of Cryptography.
...
* [crypto-js](https://github.com/brix/crypto-js) ⭐ 16,385 | 🐛 278 | 🌐 JavaScript | 📅 2024-08-09 - JavaScript library of crypto standards.
* [node.bcrypt.js](https://github.com/ncb000gt/node.bcrypt.js) ⭐ 7,801 | 🐛 34 | 🌐 C++ | 📅 2026-04-14 - bcrypt for Node.js.
* [sjcl](https://github.com/bitwiseshiftleft/sjcl) ⭐ 7,210 | 🐛 117 | 🌐 JavaScript | 📅 2026-03-18 - Stanford JavaScript Crypto Library.
* [jsencrypt](https://github.com/travist/jsencrypt) ⭐ 6,800 | 🐛 143 | 🌐 JavaScript | 📅 2026-04-08 - JavaScript library to perform OpenSSL RSA Encryption, Decryption, and Key Generation.
* [OpenPGP.js](https://github.com/openpgpjs/openpgpjs) ⭐ 5,948 | 🐛 36 | 🌐 JavaScript | 📅 2026-06-04 - OpenPGP implementation for JavaScript.
* [forge](https://github.com/digitalbazaar/forge) ⭐ 5,306 | 🐛 456 | 🌐 JavaScript | 📅 2026-03-25 - Native implementation of TLS in JavaScript and tools to write crypto-based and network-heavy webapps.
...
* [jsrsasign](https://github.com/kjur/jsrsasign) ⭐ 3,374 | 🐛 39 | 🌐 HTML | 📅 2026-04-17 - The 'jsrsasign' (RSA-Sign JavaScript Library) is an opensource free cryptography library supporting RSA/RSAPSS/ECDSA/DSA signing/validation.
* [jsThemis](https://github.com/cossacklabs/themis/wiki/Nodejs-Howto) ⭐ 1,966 | 🐛 31 | 🌐 C | 📅 2026-04-24 - JavaScript wrapper on Themis. High level crypto library for storing data (AES), secure messaging (ECC + ECDSA / RSA + PSS + PKCS#7) and session-oriented, forward secrecy data exchange (ECDH key agreement, ECC & AES encryption).
* [TweetNaCl.js](https://github.com/dchest/tweetnacl-js) ⭐ 1,924 | 🐛 6 | 🌐 JavaScript | 📅 2025-08-15 - A port of TweetNaCl / NaCl for JavaScript for modern browsers and Node.js.
* [cryptico](https://github.com/wwwtyro/cryptico) ⚠️ Archived - Easy-to-use encryption system utilizing RSA and AES for JavaScript.
* [libsodium.js](https://github.com/jedisct1/libsodium.js) ⭐ 1,137 | 🐛 1 | 🌐 HTML | 📅 2026-05-25 - libsodium compiled to pure JavaScript, with convenient wrappers.
* noble - high-security, easily auditable set of contained cryptographic libraries and tools. Zero dependencies each.
  * [noble-curves](https://github.com/paulmillr/noble-curves) ⭐ 911 | 🐛 2 | 🌐 TypeScript | 📅 2026-05-14 — elliptic curve cryptography, including Weierstrass, Edwards, Montgomery curves, pairings, hash-to-curve, poseidon hash, schnorr, secp256k1, ed25519, ed448, p521, bn254, bls12-381 and others. Also 4kb [noble-secp256k1](https://github.com/paulmillr/noble-secp256k1) ⭐ 876 | 🐛 1 | 🌐 TypeScript | 📅 2026-04-29, [noble-ed25519](https://github.com/paulmillr/noble-ed25519) ⭐ 508 | 🐛 0 | 🌐 TypeScript | 📅 2026-04-29
  * [noble-hashes](https://github.com/paulmillr/noble-hashes) ⭐ 873 | 🐛 4 | 🌐 TypeScript | 📅 2026-05-12 — SHA2, SHA3, RIPEMD, BLAKE2/3, HMAC, HKDF, PBKDF2, Scrypt & Argon2id
  * [noble-ciphers](https://github.com/paulmillr/noble-ciphers) ⭐ 393 | 🐛 2 | 🌐 TypeScript | 📅 2026-05-26 — cryptographic ciphers, including AES-SIV, Salsa20, ChaCha, Poly1305 and FF1
  * [noble-post-quantum](https://github.com/paulmillr/noble-post-quantum) ⭐ 329 | 🐛 2 | 🌐 TypeScript | 📅 2026-06-04 — ML-KEM, ML-DSA, SLH-DSA (CRYSTALS-Kyber, CRYSTALS-Dilithium, Sphincs+) and hybrids
...
* [URSA](https://github.com/quartzjer/ursa) ⭐ 614 | 🐛 65 | 🌐 JavaScript | 📅 2019-04-29 - RSA public/private key OpenSSL bindings for Node.
...
* [cryptojs](https://github.com/gwjjeff/cryptojs) ⭐ 327 | 🐛 14 | 🌐 JavaScript | 📅 2012-07-21 - Provide standard and secure cryptographic algorithms for Node.js.
...
* [micro-rsa-dsa-dh](https://github.com/paulmillr/micro-rsa-dsa-dh) ⭐ 23 | 🐛 0 | 🌐 TypeScript | 📅 2026-04-28 - Minimal implementation of older cryptography algorithms: RSA, DSA, DH, ElGamal.
...
* [Keycloak](https://github.com/keycloak/keycloak) ⭐ 34,764 | 🐛 2,821 | 🌐 Java | 📅 2026-06-06 - Open Source Identity and Access Management For Modern Applications and Services.
* [pac4j](https://github.com/pac4j/pac4j) ⭐ 2,517 | 🐛 6 | 🌐 Java | 📅 2026-06-06 - Security engine.
* [Java Themis](https://github.com/cossacklabs/themis/wiki/Java-and-Android-Howto) ⭐ 1,966 | 🐛 31 | 🌐 C | 📅 2026-04-24 - Java/Android wrapper on Themis. High level crypto library for storing data (AES), secure messaging (ECC + ECDSA / RSA + PSS + PKCS#7) and session-oriented, forward secrecy data exchange (ECDH key agreement, ECC & AES encryption).
...
* [Password4j](https://github.com/Password4j/password4j) ⭐ 422 | 🐛 10 | 🌐 Java | 📅 2026-04-16 - A Java user-friendly cryptographic library for hashing and checking passwords with different Key derivation functions (KDFs) and Cryptographic hash functions (CHFs).
* [Google Tink](https://github.com/tink-crypto/tink-java) ⭐ 288 | 🐛 11 | 🌐 Java | 📅 2026-06-04 - A small crypto library that provides a safe, simple, agile and fast way to accomplish some common crypto tasks.
...
* [SHA.jl](https://github.com/staticfloat/SHA.jl) ⭐ 52 | 🐛 4 | 🌐 Julia | 📅 2026-05-03 - Performant, 100% native-julia SHA1, SHA2-{224,256,384,512} implementation.
...
* [ocaml-tls](https://github.com/mirleft/ocaml-tls) ⭐ 320 | 🐛 5 | 🌐 OCaml | 📅 2026-05-20 - TLS in pure OCaml.
* [Digestif](https://github.com/mirage/digestif) ⭐ 95 | 🐛 8 | 🌐 OCaml | 📅 2025-05-21 - is a toolbox that implements various cryptographic primitives in C and OCaml.

### Objective-C

* [RNCryptor](https://github.com/RNCryptor/RNCryptor) ⭐ 3,359 | 🐛 9 | 🌐 Swift | 📅 2025-03-22 - CCCryptor (AES encryption) wrappers for iOS and Mac.
* [ObjC Themis](https://github.com/cossacklabs/themis/wiki/Objective-C-Howto) ⭐ 1,966 | 🐛 31 | 🌐 C | 📅 2026-04-24 - ObjC wrapper on Themis for iOS and macOS. High level crypto library for storing data (AES), secure messaging (ECC + ECDSA / RSA + PSS + PKCS#7) and session-oriented, forward secrecy data exchange (ECDH key agreement, ECC & AES encryption).
...
* [PHP Themis](https://github.com/cossacklabs/themis/wiki/PHP-Howto) ⭐ 1,966 | 🐛 31 | 🌐 C | 📅 2026-04-24 - PHP wrapper on Themis. High level crypto library for storing data (AES), secure messaging (ECC + ECDSA / RSA + PSS + PKCS#7) and session-oriented, forward secrecy data exchange (ECDH key agreement, ECC & AES encryption).
...
* [pycryptodome](https://github.com/Legrandin/pycryptodome) ⭐ 3,233 | 🐛 87 | 🌐 C | 📅 2026-03-29 - Self-contained Python package of low-level cryptographic primitives.
* [pythemis](https://github.com/cossacklabs/themis/wiki/Python-Howto) ⭐ 1,966 | 🐛 31 | 🌐 C | 📅 2026-04-24 - Python wrapper on Themis. High level crypto library for storing data (AES), secure messaging (ECC + ECDSA / RSA + PSS + PKCS#7) and session-oriented, forward secrecy data exchange (ECDH key agreement, ECC & AES encryption).
* [bcrypt](https://github.com/pyca/bcrypt) ⭐ 1,480 | 🐛 7 | 🌐 Python | 📅 2026-06-05 - Modern password hashing for your software and your servers.
* [hashids](https://github.com/davidaurelio/hashids-python) ⭐ 1,416 | 🐛 8 | 🌐 Python | 📅 2023-07-04 - Implementation of [hashids](http://hashids.org) in Python.
* [pynacl](https://github.com/pyca/pynacl) ⭐ 1,195 | 🐛 58 | 🌐 C | 📅 2026-06-03 - Python binding to the Networking and Cryptography (NaCl) library.
* [ecdsa](https://github.com/tlsfuzzer/python-ecdsa) ⭐ 977 | 🐛 17 | 🌐 Python | 📅 2026-06-05 - An easy-to-use implementation of ECC with support for ECDSA and ECDH.
* [charm](https://github.com/JHUISI/charm) ⭐ 641 | 🐛 9 | 🌐 Python | 📅 2026-04-19 - Framework for rapidly prototyping cryptosystems.
...
* [bcrypt-ruby](https://github.com/codahale/bcrypt-ruby) ⭐ 1,991 | 🐛 18 | 🌐 C | 📅 2026-03-27 - Ruby binding for the OpenBSD bcrypt() password hashing algorithm, allowing you to easily store a secure hash of your users' passwords.
* [Ruby Themis](https://github.com/cossacklabs/themis/wiki/Ruby-Howto) ⭐ 1,966 | 🐛 31 | 🌐 C | 📅 2026-04-24 - Ruby wrapper on Themis. High level crypto library for storing data (AES), secure messaging (ECC + ECDSA / RSA + PSS + PKCS#7) and session-oriented, forward secrecy data exchange (ECDH key agreement, ECC & AES encryption).
...
* [rustls](https://github.com/ctz/rustls) ⭐ 7,433 | 🐛 87 | 🌐 Rust | 📅 2026-06-05 - Rustls is a new, modern TLS library written in Rust.
* [BLAKE3](https://github.com/BLAKE3-team/BLAKE3) ⭐ 6,264 | 🐛 182 | 🌐 Assembly | 📅 2026-05-21 - is official Rust and C implementations of the BLAKE3 cryptographic hash function.
* [ockam](https://github.com/ockam-network/ockam) ⭐ 4,627 | 🐛 94 | 🌐 Rust | 📅 2026-01-04 - is a Rust library for end-to-end encryption and mutual authentication.
* [ring](https://github.com/briansmith/ring) ⭐ 4,087 | 🐛 45 | 🌐 Assembly | 📅 2026-05-20 - Safe, fast, small crypto using Rust & BoringSSL's cryptography primitives.
* [rage](https://github.com/str4d/rage) ⭐ 3,518 | 🐛 64 | 🌐 Rust | 📅 2026-04-22 - is a simple, modern, and secure file encryption tool, using the age format.
* [hashes](https://github.com/RustCrypto/hashes) ⭐ 2,219 | 🐛 31 | 🌐 Rust | 📅 2026-06-05 - Collection of cryptographic hash functions written in pure Rust.
* [rust-openssl](https://github.com/sfackler/rust-openssl) ⭐ 1,622 | 🐛 346 | 🌐 Rust | 📅 2026-06-04 - OpenSSL bindings for Rust.
...
* [mundane](https://github.com/google/mundane) ⭐ 1,081 | 🐛 10 | 🌐 Rust | 📅 2023-07-07 - is a Rust cryptography library backed by BoringSSL that is difficult to misuse, ergonomic, and performant.
* [snow](https://github.com/mcginty/snow?tab=readme-ov-file) ⭐ 1,072 | 🐛 38 | 🌐 Rust | 📅 2026-04-14 - Pure Rust implementation of Trevor Perrin’s [Noise Protocol](https://noiseprotocol.org/noise.html).
* [AEADs](https://github.com/RustCrypto/AEADs) ⭐ 932 | 🐛 38 | 🌐 Rust | 📅 2026-05-28 - Authenticated Encryption with Associated Data Algorithms: high-level encryption ciphers.
* [password-hashes](https://github.com/RustCrypto/password-hashes) ⭐ 889 | 🐛 16 | 🌐 Rust | 📅 2026-06-01 - Collection of password hashing algorithms, otherwise known as password-based key derivation functions, written in pure Rust.
* [elliptic-curves](https://github.com/RustCrypto/elliptic-curves) ⭐ 855 | 🐛 67 | 🌐 Rust | 📅 2026-06-04 - Collection of pure Rust elliptic curve implementations: NIST P-224, P-256, P-384, P-521, secp256k1, SM2.
* [orion](https://github.com/orion-rs/orion) ⭐ 718 | 🐛 18 | 🌐 Rust | 📅 2026-06-04 - is a cryptography library written in pure Rust. It aims to provide easy and usable crypto while trying to minimize the use of unsafe code.
...
* [signatures](https://github.com/RustCrypto/signatures) ⭐ 641 | 🐛 14 | 🌐 Rust | 📅 2026-06-05 - Cryptographic signature algorithms: DSA, ECDSA, Ed25519.
* [webpki](https://github.com/briansmith/webpki) ⭐ 483 | 🐛 109 | 🌐 Rust | 📅 2025-01-21 - Web PKI TLS X.509 certificate validation in Rust.
* [proteus](https://github.com/wireapp/proteus) ⭐ 419 | 🐛 5 | 🌐 Rust | 📅 2026-06-03 - Axolotl protocol implementation, without header keys, in Rust.
* [ronkathon](https://github.com/pluto/ronkathon) ⭐ 345 | 🐛 45 | 🌐 Rust | 📅 2025-11-24 - Educational, mathematically transparent, well documentated cryptography in rust.
* [dryoc](https://github.com/brndnmtthws/dryoc) ⭐ 335 | 🐛 0 | 🌐 Rust | 📅 2026-06-05 - A pure-Rust, general purpose crypto library that implements libsodium primitives.
* [formats](https://github.com/RustCrypto/formats) ⭐ 320 | 🐛 52 | 🌐 Rust | 📅 2026-06-05 - Cryptography-related format encoders/decoders: DER, PEM, PKCS, PKIX.
* [cryptoballot](https://github.com/cryptoballot/cryptoballot) ⭐ 223 | 🐛 12 | 🌐 Rust | 📅 2024-08-05 - Cryptographically secure online voting.
* [recrypt](https://github.com/IronCoreLabs/recrypt-rs) ⭐ 166 | 🐛 6 | 🌐 Rust | 📅 2026-06-02 - A pure-Rust library that implements cryptographic primitives for building a multi-hop Proxy Re-encryption scheme, known as Transform Encryption.
...
* [botan-rs](https://github.com/randombit/botan-rs) ⭐ 45 | 🐛 4 | 🌐 Rust | 📅 2026-05-07 - Botan bindings for Rust.
...
* [recrypt](https://github.com/IronCoreLabs/recrypt) ⭐ 36 | 🐛 0 | 🌐 Scala | 📅 2026-05-26 - Transform encryption library for Scala.

### Scheme

* [guile-ssh](https://github.com/artyom-poptsov/guile-ssh) ⭐ 74 | 🐛 4 | 🌐 C | 📅 2026-03-25 - libssh bindings for GNU Guile.
...
* [CryptoSwift](https://github.com/krzyzanowskim/CryptoSwift) ⭐ 10,556 | 🐛 4 | 🌐 Swift | 📅 2026-04-22 - Crypto related functions and helpers for Swift implemented in Swift programming language.
* [SwiftThemis](https://github.com/cossacklabs/themis/wiki/Swift-Howto) ⭐ 1,966 | 🐛 31 | 🌐 C | 📅 2026-04-24 - Swift wrapper on Themis for iOS and macOS. High level crypto library for storing data (AES), secure messaging (ECC + ECDSA / RSA + PSS + PKCS#7) and session-oriented, forward secrecy data exchange (ECDH key agreement, ECC & AES encryption).
* [Swift-Sodium](https://github.com/jedisct1/swift-sodium) ⭐ 547 | 🐛 0 | 🌐 C | 📅 2026-05-04 - Swift interface to the Sodium library for common crypto operations for iOS and macOS.
...
Your contributions are always welcome! Please take a look at the [contribution guidelines](https://github.com/sobolevn/awesome-cryptography/blob/master/CONTRIBUTING.md) ⭐ 6,982 | 🐛 60 | 📅 2026-06-01 first.
